...
## Deploy na Nuvem (Instruções de Acesso)

A aplicação está hospedada na nuvem para facilitar a avaliação.

-   **URL da Aplicação Online:** [**COLE AQUI A URL DO SEU DEPLOY NA NUVEM APÓS FAZER O DEPLOY**]
    *(Exemplo: `https://seu-app-logap.render.com/`)*
...
**84 991415330**
**murilosilvafrancisco49@gmail.com**
**https://www.linkedin.com/in/murilosilvaof/**
**https://github.com/murilosilvaof**